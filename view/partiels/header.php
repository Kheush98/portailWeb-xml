...
<header class="w-full text-white bg-rose-900 shadow-sm body-font fixed top-0 w-full z-10">
    <div class="container flex flex-col items-start justify-between p-4 mx-auto md:flex-row">
        ...
        <nav class="flex flex-wrap items-center justify-center pl-6 ml-6 text-base border-l border-gray-200 md:mr-auto">
            <a href="index.php?action=index&controller=home" class="mr-2 font-medium  hover:bg-white hover:text-rose-900 p-2 rounded-md">Home</a>
            <a href="index.php?action=index&controller=film" class="mr-2 font-medium  hover:bg-white hover:text-rose-900 p-2 rounded-md">Films</a>
            <a href="index.php?action=index&controller=restaurant" class="mr-2 font-medium  hover:bg-white hover:text-rose-900 p-2 rounded-md">Restaurants</a>
