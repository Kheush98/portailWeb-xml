      ...
      <div class="mx-auto grid max-w-2xl grid-cols-1 items-start gap-x-8 gap-y-16 sm:gap-y-24 lg:mx-0 lg:max-w-none lg:grid-cols-2">
        <div class="lg:pr-4">
          <div class="relative overflow-hidden rounded-3xl bg-gray-900 px-6 pb-9 pt-64 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
            <img class="absolute inset-0 h-full w-full object-cover brightness-125 saturate-0" src="img/film.jpg" alt="">
            ...
            <figure class="relative isolate">
              ...
              <figcaption class="mt-6 text-sm leading-6 text-gray-300"><strong class="font-semibold text-white">De,</strong> <?php echo $film->realisateur ?></</figcaption>
              <figcaption class=" text-sm leading-6 text-gray-300">Langue : <?php echo $film->langue['code']?></</figcaption>
            </figure>
          </div>
        </div>
        <div>
          <div class="text-base leading-7 text-gray-700 lg:max-w-lg">
            <h1 class=" text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl text-center"><?php echo $film->titre ?></</h1>
          </div>
          <dl class="mt-10 grid grid-cols-2 gap-8 border-t border-gray-900/10 pt-10 sm:grid-cols-2">
            <div>
              <dd class="mt-2 text-lg font-bold leading-10 tracking-tight text-gray-900">Genre</dd>
              <dt class="text-sm font-semibold leading-6 text-gray-600"><?php echo $film->genre ?></dt>
            </div>
            <div>
              <dd class="mt-2 text-lg font-bold leading-10 tracking-tight text-gray-900">Durée</dd>
              <dt class="text-sm font-semibold leading-6 text-gray-600"><?php echo $film->duree['heures'].'h'.' '.$film->duree['minutes'].'min' ?></</dt>
            </div>
            <div>
              <dd class=" text-lg font-bold leading-10 tracking-tight text-gray-900">Acteurs</dd>
            ...
            <div>
              <dd class=" text-lg font-bold leading-10 tracking-tight text-gray-900">Année</dd>
